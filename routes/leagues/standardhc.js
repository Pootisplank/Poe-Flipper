...
router.get('/', async (req, res) => {
    console.log('/standardhc endpoint called')
    const dataCurrency = await getData('Currency')
    const currency = processData(dataCurrency)
    res.render('leagues/standardhc/currency', {currency:currency})
})

router.get('/currency', async (req, res) => {
    console.log('/standardhc/currency endpoint called')
    const dataCurrency = await getData('Currency')
    const currency = processData(dataCurrency)
    res.render('leagues/standardhc/currency', {currency:currency})
})
...
router.get('/fragment', async (req, res) => {
    console.log('/standardhc/fragment endpoint called')
    const dataFragment = await getData('Fragment')
    const fragment = processData(dataFragment)
    res.render('leagues/standardhc/fragment', {fragment:fragment})
})
